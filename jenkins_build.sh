...
run_tests() {
    if [ "$result" == "0" ]; then
        if [ "$tests"  == true ]; then make tests  ; fi
        if [ "$teste"  == true ]; then make teste  ; fi
        if [ "$testv"  == true ]; then make testv  ; fi
        if [ "$testvw" == true ]; then make testvw ; fi
        if [ "$testx"  == true ]; then make testx  ; fi
    fi
}
